 ...
 */
export type CreatePlanarSurface = {
/**
 ...
 * Edge ID.
 */
id: string, } } | { "edge_reference": {
/**
 * Stable edge reference.
 */
reference: EdgeSpecifier, } } | { "axis": {
/**
 * Axis to use as mirror.
 */
axis: Point3d<number>,
