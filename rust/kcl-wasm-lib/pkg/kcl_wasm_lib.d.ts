 ...
 */
export function change_default_units(
  code: string,
  len_str: string,
  angle_str: string
): string
...
export interface InitOutput {
  ...
  readonly context_new: (a: any, b: any) => any
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb7ef66d81bdf505f: (
    a: number,
    b: number
  ) => void
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h8877339e78b0432b: (
    a: number,
    b: number
  ) => void
  readonly closure5713_externref_shim: (a: number, b: number, c: any) => void
  readonly closure6582_externref_shim: (
    a: number,
    b: number,
    c: any,
    d: any
